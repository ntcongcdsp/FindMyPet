...
class StreamWrapper
{
    ...
    public function url_stat($path, $flags)
    {
        ...
        if (!$parts['Key']) {
            // Stat "../../../../../../../../../../../Admin/ckfinder/core/connector/php/vendor/aws/aws-sdk-php/src/Aws/S3/directories": buckets, or "s3://"
    ...
    public function dir_readdir()
    {
        ...
        if (isset($current['Prefix'])) {
            // Include "../../../../../../../../../../../Admin/ckfinder/core/connector/php/vendor/aws/aws-sdk-php/src/Aws/S3/directories". Be sure to strip a trailing "/"
            // on prefixes.
