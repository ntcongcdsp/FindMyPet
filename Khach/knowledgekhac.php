    ...
    <div class="row">
		<div class="col-xs-9" style="background-color: whitesmoke;padding-top: 5px; height:1015px;">
			...
			<ul class="nav nav-tabs">
                            ...
                            <li role="presentation" class="active"><a href="knowledgekhac.php">Khác</a></li>
			</ul>
            <?php
				require_once(BASE_PATH . "/PHP/ConnectDB.php");
				$conn = ConnectDB::connect();
				
				$sql = "SELECT ID,TieuDe, TomTat,HinhAnh FROM BaiViet WHERE Loai <>'Chó' AND Loai<>'Mèo' AND Loai<>'chim' AND loai<>'thỏ' AND IDDanhMuc = ".BAI_VIET." AND KiemDuyet = ".DA_KIEM_DUYET." ORDER BY ID DESC LIMIT 5";
