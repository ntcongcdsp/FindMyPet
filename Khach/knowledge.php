    ...
    <div class="row">
		<div class="col-xs-9" style="background-color: whitesmoke;padding-top: 5px; height:1015px;">
			...
			<ul class="nav nav-tabs">
				<li role="presentation" class="active"><a href="#">Tất cả</a></li>
				<li role="presentation"><a href="#">Chóa</a></li>
				<li role="presentation"><a href="#">Meo meo</a></li>
				<li role="presentation"><a href="#">Trym</a></li>
				<li role="presentation"><a href="#">Thỏ</a></li>
				<li role="presentation"><a href="#">Khác</a></li>
			</ul>
            <div class="row" style="height:145px;margin-top: 5px;">
        ...
        <div class="col-xs-3" style="width:240px;height:1015px; margin-top:5px;">
