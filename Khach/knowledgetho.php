    ...
    <div class="row">
		<div class="col-xs-9" style="background-color: whitesmoke;padding-top: 5px; height:1015px;">
			...
			<ul class="nav nav-tabs">
                            ...
                            <li role="presentation" class="active"><a href="knowledgetho.php">Thỏ</a></li>
...
<?php
				...
				$sql = "SELECT ID,TieuDe, TomTat,HinhAnh FROM BaiViet WHERE Loai = 'thỏ' AND IDDanhMuc = ".BAI_VIET." AND KiemDuyet = ".DA_KIEM_DUYET." ORDER BY ID DESC LIMIT 5";
