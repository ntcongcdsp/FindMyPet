<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$sql = "UPDATE User SET MatKhau='".$_POST['txtMatKhau']."', Ho = '".$_POST['txtHo']."', Ten = '".$_POST['txtTen']."', Email='".$_POST['txtEmail']."', DiaChi='".$_POST['txtDiaChi']."', SoDienThoai='".$_POST['txtSoDienThoai']."' WHERE TenDN = '".$_SESSION['TenDN']."'";
...
<div class="container" style="background-color: whitesmoke;width:980px; border-radius: 5px;">
    ...
    <div class="row">
        ...
        <?php
			require_once("../PHP/ConnectDB.php");
			$conn = ConnectDB::connect();
			$sql = "SELECT * FROM User WHERE TenDN = '".$_SESSION['TenDN']."'";
        ...
        <form class="form-horizontal" name="frmSuaTaiKhoan" method="post" enctype="multipart/form-data">
                <div class="form-group">
    				...
    				<div class="col-sm-5">
      					<input type="text" disabled class="form-control" name="txtTenDN" value="<?php echo $_SESSION['TenDN']?>">
    				</div>
  				</div>
                <div class="form-group">
