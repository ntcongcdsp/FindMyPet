<?php
	...
	if(isset($_POST['submit']))
	{
		if($_POST['txtTenDN'] != "")
		{
			...
			$sql= "INSERT INTO User (TenDN, MatKhau, MaPhanQuyen, Ho, Ten, Email, DiaChi, SoDienThoai) VALUES ('".$_POST['txtTenDN']."','".$_POST['txtMatKhau']."',".$_POST['slPhanQuyen'].",'".$_POST['txtHo']."','".$_POST['txtTen']."','".$_POST['txtEmail']."','".$_POST['txtDiaChi']."','".$_POST['txtSoDienThoai']."')";
