    ...
    <div class="row">
        ...
        <form class="form-horizontal" name="frmSuaTaiKhoan" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
    				...
    				<div class="col-sm-5">
      					<input type="text" class="form-control" name="txtNgayDang" placeholder="Ngày đăng">
    				</div>
  				</div>
                <div class="form-group">
