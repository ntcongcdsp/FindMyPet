<?php
	...
	if(isset($_GET['submit']))
	{
		...
		$sql = "DELETE FROM Slider WHERE ID = ".$_GET['txtID'];
		
		if($conn->query($sql) === TRUE)
		{
			echo "Xoa du lieu thanh cong";
			ConnectDB::disconnect();
			header('Location: QLAnhVuiThuCung.php');
		}
		else
		{
...
<body style="background-color: lightgrey;min-height:100%;">
    ...
    <div class="container" style="background-color: whitesmoke;width:980px; border-radius: 5px;">
		<div class="bg-danger">
        	<h1>Xóa Ảnh vui thú cưng - <?php echo "<img class='imgSlide' src='../img/AnhVui/".$_GET['TenFile']."'>";?></h1>
        ...
        <div class="control_group">
             <form class="form-horizontal" name="frmXoaDanhMuc" method="get">
                ...
                <div class="form-group">
                    ...
                    <a href="QLAnhVuiThuCung.php"><button type="button" class="btn btn-default">Trở về</button></a>
                    </div>
                </div>
            </form>
        </div>
